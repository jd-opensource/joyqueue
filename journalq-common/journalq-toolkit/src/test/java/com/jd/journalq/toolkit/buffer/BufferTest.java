...
public abstract class BufferTest {
    ...
    @Test
    public void testReadIntThrowsIndexOutOfBoundsNoRemainingBytesRelative() {
        try {
    ...
    @Test
    public void testWriteIntThrowsIndexOutOfBoundsWithNoRemainingBytesRelative() {
        try {
    ...
    @Test
    public void testReadIntThrowsIndexOutOfBoundsNoRemainingBytesAbsolute() {
        try {
    ...
    public void testWriteReadFloatRelative() {
        assertEquals(createBuffer(16).writeFloat(10.6f).flip().readFloat(), 10.6f, 0.0);
    }

    @Test
    public void testWriteReadFloatAbsolute() {
        assertEquals(createBuffer(16).writeFloat(4, 10.6f).readFloat(4), 10.6f, 0.0);
    }

    @Test
    public void testWriteReadDoubleRelative() {
        assertEquals(createBuffer(16).writeDouble(10.6).flip().readDouble(), 10.6, 0.0);
    }

    @Test
    public void testWriteReadDoubleAbsolute() {
        assertEquals(createBuffer(16).writeDouble(4, 10.6).readDouble(4), 10.6, 0.0);
    }
    ...
    public void testSwappedMarkReset() {
        assertTrue(createBuffer(12).order(ByteOrder.LITTLE_ENDIAN).writeInt(10).mark().writeBoolean(true).reset()
                .readBoolean());
    }

    @Test
    public void testSwappedReadIntThrowsIndexOutOfBoundsWithNoRemainingBytesRelative() {
        try {
    ...
    @Test
    public void testSwappedWriteIntThrowsIndexOutOfBoundsWithNoRemainingBytesRelative() {
        try {
    ...
    @Test
    public void testSwappedReadIntThrowsIndexOutOfBoundsWithNoRemainingBytesAbsolute() {
        try {
    ...
    public void testSwappedWriteReadUnsignedByteRelative() {
        assertEquals(createBuffer(16).order(ByteOrder.LITTLE_ENDIAN).writeUnsignedByte(10).flip().readUnsignedByte(),
                10);
    }
    ...
    public void testSwappedWriteReadUnsignedShortRelative() {
        assertEquals(createBuffer(16).order(ByteOrder.LITTLE_ENDIAN).writeUnsignedShort((short) 10).flip()
    ...
    public void testSwappedWriteReadUnsignedShortAbsolute() {
        assertEquals(
                createBuffer(16).order(ByteOrder.LITTLE_ENDIAN).writeUnsignedShort(4, (short) 10).readUnsignedShort(4),
                10);
    }
    ...
    public void testSwappedWriteReadFloatRelative() {
        assertEquals(createBuffer(16).order(ByteOrder.LITTLE_ENDIAN).writeFloat(10.6f).flip().readFloat(), 10.6f, 0.0);
    }

    @Test
    public void testSwappedWriteReadFloatAbsolute() {
        assertEquals(createBuffer(16).order(ByteOrder.LITTLE_ENDIAN).writeFloat(4, 10.6f).readFloat(4), 10.6f, 0.0);
    }

    @Test
    public void testSwappedWriteReadDoubleRelative() {
        assertEquals(createBuffer(16).order(ByteOrder.LITTLE_ENDIAN).writeDouble(10.6).flip().readDouble(), 10.6, 0.0);
    }

    @Test
    public void testSwappedWriteReadDoubleAbsolute() {
        assertEquals(createBuffer(16).order(ByteOrder.LITTLE_ENDIAN).writeDouble(4, 10.6).readDouble(4), 10.6, 0.0);
    }
