...
public class Joiner {
     ...
     */
    public final <A extends Appendable> A appendTo(final A appendable, final Object first, final Object second,
            final Object... rest) throws IOException {
    ...
    public final StringBuilder appendTo(final StringBuilder builder, final Object first, final Object second,
            final Object... rest) {
    ...
    public static final class MapJoiner {
        ...
        MapJoiner(final Joiner joiner, final String keyValueSeparator) {
        ...
        public <A extends Appendable> A appendTo(final A appendable,
                final Iterable<? extends Entry<?, ?>> entries) throws IOException {
         ...
         * @since 11.0
         */
        public <A extends Appendable> A appendTo(final A appendable, final Iterator<? extends Entry<?, ?>> parts) throws
                IOException {
            Preconditions.checkNotNull(appendable);
            if (parts.hasNext()) {
         ...
         * @since 10.0
         */
        public StringBuilder appendTo(final StringBuilder builder, final Iterable<? extends Entry<?, ?>> entries) {
         ...
         * @since 11.0
         */
        public StringBuilder appendTo(final StringBuilder builder, final Iterator<? extends Entry<?, ?>> entries) {
            try {
         ...
         * @since 10.0
         */
        public String join(final Iterable<? extends Entry<?, ?>> entries) {
         ...
         * @since 11.0
         */
        public String join(final Iterator<? extends Entry<?, ?>> entries) {
    ...
    static Iterable<Object> iterable(final Object first, final Object second, final Object[] rest) {
