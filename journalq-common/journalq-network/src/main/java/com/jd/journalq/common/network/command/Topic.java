...
public class Topic implements Serializable {
    ...
    private com.jd.journalq.common.domain.Topic.Type type;
    ...
    public com.jd.journalq.common.domain.Topic.Type getType() {
        return type;
    }

    public void setType(com.jd.journalq.common.domain.Topic.Type type) {
        this.type = type;
    }
