 ...
 * date: 2018/11/29
 */
public class AddConnectionRequestCodec implements PayloadCodec<JournalqHeader, AddConnectionRequest>, Type {

    @Override
    public AddConnectionRequest decode(JournalqHeader header, ByteBuf buffer) throws Exception {
