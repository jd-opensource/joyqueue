...
import com.jd.joyqueue.convert.NsrTopicConverter;
import com.jd.joyqueue.exception.ServiceException;
import com.jd.joyqueue.model.domain.OperLog;
import com.jd.joyqueue.model.domain.PartitionGroupMaster;
...
import com.jd.joyqueue.nsr.TopicNameServerService;
...
import static com.jd.joyqueue.exception.ServiceException.IGNITE_RPC_ERROR;
...
public class TopicNameServerServiceImpl extends NameServerBase implements TopicNameServerService {
    ...
    public PageResult<Topic> findByQuery(QPageQuery<QTopic> query) throws Exception {
        ...
        PageResult<com.jd.joyqueue.domain.Topic> pageResult = JSON.parseObject(result,new TypeReference<PageResult<com.jd.joyqueue.domain.Topic>>(){});
    ...
    public int delete(Topic model) throws Exception {
        com.jd.joyqueue.domain.Topic nsrTopic = nsrTopicConverter.convert(model);
       String result = postWithLog(REMOVE_TOPIC,nsrTopic,OperLog.Type.TOPIC.value(),OperLog.OperType.DELETE.value(),nsrTopic.getName().getCode());
       return isSuccess(result);
    }
    ...
    public List<Topic> findByQuery(QTopic query) throws Exception {
        ...
        List<com.jd.joyqueue.domain.Topic> topics = JSON.parseArray(result, com.jd.joyqueue.domain.Topic.class);
    ...
    public Topic findById(String id) {
        try {
            com.jd.joyqueue.domain.Topic nsrToic= JSON.parseObject(post(GETBYID_TOPIC,id), com.jd.joyqueue.domain.Topic.class);
    ...
    private TopicQuery topicQueryConvert(QTopic qTopic){
        ...
        if (qTopic.getType() >= 0) {
            topicQuery.setType(com.jd.joyqueue.domain.Topic.Type.valueOf((byte) qTopic.getType()).code());
        }
