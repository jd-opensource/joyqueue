...
import com.jd.joyqueue.convert.NsrProducerConverter;
...
public class ProducerNameServerServiceImpl extends NameServerBase implements ProducerNameServerService {
    ...
    public int add(Producer producer) throws Exception {
        com.jd.joyqueue.domain.Producer nsrProducer = nsrProducerConverter.convert(producer);
    ...
    public List<Producer> syncProducer(byte clientType) throws Exception {
        ...
        List<com.jd.joyqueue.domain.Producer>  nsrProducers = JSONArray.parseArray(post(PRODUCER_GETALL_BY_CLIENTTYPE,request), com.jd.joyqueue.domain.Producer.class);
    ...
    public PageResult<Producer> findByQuery(QPageQuery<QProducer> query) throws Exception {
        ...
        PageResult<com.jd.joyqueue.domain.Producer> pageResult = JSON.parseObject(result,new TypeReference<PageResult<com.jd.joyqueue.domain.Producer>>(){});
    ...
    public List<Producer> getListProducer(ProducerQuery producerQuery) throws Exception {
        ...
        List<com.jd.joyqueue.domain.Producer> producerList = JSON.parseArray(result).toJavaList(com.jd.joyqueue.domain.Producer.class);
    ...
    public Producer findById(String nsrProducerId) throws Exception {
        ...
        com.jd.joyqueue.domain.Producer nsrProducer = JSONObject.parseObject(result, com.jd.joyqueue.domain.Producer.class);
