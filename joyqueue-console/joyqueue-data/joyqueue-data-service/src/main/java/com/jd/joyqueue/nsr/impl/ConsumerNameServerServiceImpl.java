...
import com.jd.joyqueue.convert.NsrConsumerConverter;
...
import com.jd.joyqueue.nsr.ConsumerNameServerService;
...
import static com.jd.joyqueue.model.domain.Namespace.DEFAULT_NAMESPACE_CODE;
import static com.jd.joyqueue.model.domain.Namespace.DEFAULT_NAMESPACE_ID;
...
public class ConsumerNameServerServiceImpl extends NameServerBase implements ConsumerNameServerService {
    ...
    public int add(Consumer consumer) throws Exception {
        com.jd.joyqueue.domain.Consumer nsrConsumer = nsrConsumerConverter.convert(consumer);
    ...
    public int delete(Consumer consumer) throws Exception {
        com.jd.joyqueue.domain.Consumer nsrConsumer = new com.jd.joyqueue.domain.Consumer();
    ...
    public List<Consumer> syncConsumer(byte clientType) throws Exception{
        ...
        List<com.jd.joyqueue.domain.Consumer>  nsrConsumers = JSONArray.parseArray(post(CONSUMER_GETALL_BY_CLIENTTYPE,request), com.jd.joyqueue.domain.Consumer.class);
    ...
    public PageResult<Consumer> findByQuery(QPageQuery<QConsumer> query) throws Exception {
        ...
        PageResult<com.jd.joyqueue.domain.Consumer> pageResult = JSON.parseObject(result,new TypeReference<PageResult<com.jd.joyqueue.domain.Consumer>>(){});
    ...
    public List<Consumer> findByQuery(QConsumer qConsumer) throws Exception {
        ...
        List<com.jd.joyqueue.domain.Consumer> consumerList = JSON.parseArray(result).toJavaList(com.jd.joyqueue.domain.Consumer.class);
    ...
    public Consumer findById(String  id) throws Exception {
        ...
        com.jd.joyqueue.domain.Consumer nsrConsumer = JSONObject.parseObject(result, com.jd.joyqueue.domain.Consumer.class);
