 ...
 */
public class NsrDataCenterConverter extends Converter<DataCenter, com.jd.joyqueue.domain.DataCenter> {
    @Override
    protected com.jd.joyqueue.domain.DataCenter forward(DataCenter dataCenter) {
        com.jd.joyqueue.domain.DataCenter nsrDataCenter = new com.jd.joyqueue.domain.DataCenter();
    ...
    @Override
    protected DataCenter backward(com.jd.joyqueue.domain.DataCenter nsrDataCenter) {
