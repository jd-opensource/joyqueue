...
//    @Around("execution(* com.jd.joyqueue.service.BrokerMonitorService.*(..))&&execution(* com.jd.joyqueue.nsr.*.*(..))")

    @Around("execution(* com.jd.joyqueue.service.BrokerMonitorService.*(..))")
