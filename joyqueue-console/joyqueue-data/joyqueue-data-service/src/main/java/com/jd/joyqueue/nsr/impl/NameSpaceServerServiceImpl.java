...
import com.jd.joyqueue.convert.NsrNameSpaceConverter;
import com.jd.joyqueue.model.domain.Namespace;
import com.jd.joyqueue.model.domain.OperLog;
import com.jd.joyqueue.model.query.QNamespace;
import com.jd.joyqueue.nsr.model.NamespaceQuery;
import com.jd.joyqueue.nsr.NameServerBase;
import com.jd.joyqueue.nsr.NameSpaceServerService;
import org.springframework.stereotype.Service;

import java.util.List;
import java.util.stream.Collectors;

import static com.jd.joyqueue.model.domain.OperLog.Type.NAMESPACE;
...
public class NameSpaceServerServiceImpl extends NameServerBase implements NameSpaceServerService {
    ...
    public int add(Namespace model){
        com.jd.joyqueue.domain.Namespace namespace = nsrNameSpaceConverter.convert(model);
    ...
    public Namespace findById(String s) throws Exception {
        ...
        com.jd.joyqueue.domain.Namespace namespace = JSON.parseObject(result, com.jd.joyqueue.domain.Namespace.class);
    ...
    public PageResult<Namespace> findByQuery(QPageQuery<QNamespace> query) throws Exception {
        ...
        PageResult<com.jd.joyqueue.domain.Namespace> namespacePageResult = JSON.parseObject(result,new TypeReference<PageResult<com.jd.joyqueue.domain.Namespace>>(){});
    ...
    public List<Namespace> findByQuery(QNamespace query) throws Exception {
        ...
        List<com.jd.joyqueue.domain.Namespace> namespaceList = JSON.parseArray(result).toJavaList(com.jd.joyqueue.domain.Namespace.class);
