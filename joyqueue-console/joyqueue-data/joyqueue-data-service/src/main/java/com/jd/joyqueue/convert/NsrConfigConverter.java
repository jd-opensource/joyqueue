 ...
 */
public class NsrConfigConverter extends Converter<Config, com.jd.joyqueue.domain.Config> {

    @Override
    protected com.jd.joyqueue.domain.Config forward(Config config) {
    ...
    @Override
    protected Config backward(com.jd.joyqueue.domain.Config nsrConfig) {
