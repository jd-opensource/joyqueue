...
import com.jd.joyqueue.convert.NsrDataCenterConverter;
...
public class DataCenterNameServerServiceImpl extends NameServerBase implements DataCenterNameServerService {
    ...
    public List<DataCenter> findAllDataCenter(DataCenterQuery dataCenterQuery) throws Exception {
        ...
        List<com.jd.joyqueue.domain.DataCenter> dataCenterList = JSON.parseArray(result).toJavaList(com.jd.joyqueue.domain.DataCenter.class);
    ...
    public int add(DataCenter dataCenter) throws Exception {
        com.jd.joyqueue.domain.DataCenter nsrDataCenter = nsrDataCenterConverter.convert(dataCenter);
    ...
    public int delete(DataCenter dataCenter) throws Exception {
        com.jd.joyqueue.domain.DataCenter nsrConfig = nsrDataCenterConverter.convert(dataCenter);
    ...
    public DataCenter findById(String id) throws Exception {
        ...
        com.jd.joyqueue.domain.DataCenter nsrDataCenter = JSON.parseObject(result, com.jd.joyqueue.domain.DataCenter.class);
    ...
    public PageResult<DataCenter> findByQuery(QPageQuery<QDataCenter> query) throws Exception {
        ...
        PageResult<com.jd.joyqueue.domain.DataCenter> pageResult = JSON.parseObject(result,new TypeReference<PageResult<com.jd.joyqueue.domain.DataCenter>>(){});
