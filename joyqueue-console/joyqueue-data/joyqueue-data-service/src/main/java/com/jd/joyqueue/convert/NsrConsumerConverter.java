...
import com.jd.joyqueue.model.domain.AppName;
import com.jd.joyqueue.model.domain.Consumer;
import com.jd.joyqueue.model.domain.ConsumerConfig;
 ...
 */
public class NsrConsumerConverter extends Converter<Consumer, com.jd.joyqueue.domain.Consumer> {
    @Override
    protected com.jd.joyqueue.domain.Consumer forward(Consumer consumer) {
        ...
        if (consumer.getConfig() != null) {
            nsrConsumer.setConsumerPolicy(com.jd.joyqueue.domain.Consumer.ConsumerPolicy.Builder.build()
            ...
            nsrConsumer.setLimitPolicy(new com.jd.joyqueue.domain.Consumer.ConsumerLimitPolicy(consumer.getConfig().getLimitTps(), consumer.getConfig().getLimitTraffic()));
        }
        return nsrConsumer;
    }

    @Override
    protected Consumer backward(com.jd.joyqueue.domain.Consumer nsrConsumer) {
        ...
        com.jd.joyqueue.domain.Consumer.ConsumerPolicy consumerPolicy = nsrConsumer.getConsumerPolicy();
        ...
        com.jd.joyqueue.domain.Consumer.ConsumerLimitPolicy limitPolicy = nsrConsumer.getLimitPolicy();
        if (limitPolicy != null) {
