...
import com.jd.joyqueue.convert.NsrBrokerConverter;
...
import com.jd.joyqueue.nsr.BrokerNameServerService;
...
public class BrokerNameServerServiceImpl extends NameServerBase implements BrokerNameServerService {
    ...
    public Broker findById(Long id) throws Exception {
        ...
        com.jd.joyqueue.domain.Broker nsrBroker = JSON.parseObject(result, com.jd.joyqueue.domain.Broker.class);
    ...
    public PageResult<Broker> findByQuery(QPageQuery<QBroker> query) {
        ...
        try {
            ...
            PageResult<com.jd.joyqueue.domain.Broker> brokerPageResult = JSON.parseObject(result,new TypeReference<PageResult<com.jd.joyqueue.domain.Broker>>(){});
    ...
    public int add(Broker broker) throws Exception {
        com.jd.joyqueue.domain.Broker nsrBroker = nsrBrokerConverter.convert(broker);
    ...
    public int update(Broker broker) throws Exception {
        ...
        if(nsrBroker == null) {
            nsrBroker = new com.jd.joyqueue.domain.Broker();
        }
    ...
    public List<Broker> findByQuery(QBroker query) throws Exception {
        ...
        List<com.jd.joyqueue.domain.Broker> nsrBrokers = JSONArray.parseArray(post(LIST_BROKER,brokerQuery), com.jd.joyqueue.domain.Broker.class);
    ...
    public List<Broker> getByIdsBroker(List<Integer> ids) throws Exception {
        ...
        List<com.jd.joyqueue.domain.Broker> brokerList = JSON.parseArray(result, com.jd.joyqueue.domain.Broker.class);
    ...
    public List<Broker> syncBrokers() throws Exception {
        List<com.jd.joyqueue.domain.Broker>  nsrBrokers = JSONArray.parseArray(post(LIST_BROKER,null), com.jd.joyqueue.domain.Broker.class);
