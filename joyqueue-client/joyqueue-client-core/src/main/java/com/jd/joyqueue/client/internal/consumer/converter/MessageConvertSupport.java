 ...
 */
package com.jd.joyqueue.client.internal.consumer.converter;

import com.google.common.collect.Lists;
import com.google.common.collect.Maps;
import com.jd.joyqueue.client.internal.Plugins;
...
public class MessageConvertSupport {
    ...
    public BrokerMessage convert(BrokerMessage message) {
        ...
        if (messageConverter == null) {
            logger.warn("message converter not exist, message: {}", message);
            return null;
        }
