/**
 * Copied from Apache Kafka org.apache.kafka.common.record.KafkaLZ4BlockOutputStream.
 *
 * Original LICENSE :
 *
 ...
 */
package io.chubao.joyqueue.client.internal.consumer.converter.kafka.compressor.lz4;

import io.chubao.joyqueue.client.internal.consumer.converter.kafka.KafkaBufferUtils;
...
public final class KafkaLZ4BlockOutputStream extends FilterOutputStream {
    ...
    private void writeHeader() throws IOException {
        KafkaBufferUtils.writeUnsignedIntLE(buffer, 0, MAGIC);
        bufferOffset = 4;
    ...
    private void writeBlock() throws IOException {
        ...
        // Write content
        KafkaBufferUtils.writeUnsignedIntLE(out, compressedLength | compressMethod);
        ...
        if (flg.isBlockChecksumSet()) {
            ...
            KafkaBufferUtils.writeUnsignedIntLE(out, hash);
        }
        bufferOffset = 0;
    }
    ...
    private void writeEndMark() throws IOException {
        KafkaBufferUtils.writeUnsignedIntLE(out, 0);
