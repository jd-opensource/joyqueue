 ...
 * date: 2018/8/21
 */
public class JournalqHeader implements Header {
    ...
    public JournalqHeader() {
    }

    public JournalqHeader(int type) {
        this(Direction.REQUEST, type);
    }

    public JournalqHeader(Direction direction, int type) {
        this(direction, QosLevel.RECEIVE, type);
    }

    public JournalqHeader(Direction direction, QosLevel qosLevel, int type) {
        this.type = type;
    ...
    public JournalqHeader(byte version, QosLevel qosLevel, Direction direction, int requestId, int type, long time, short status, String error) {
        this.version = version;
        this.qosLevel = qosLevel;
        this.direction = direction;
