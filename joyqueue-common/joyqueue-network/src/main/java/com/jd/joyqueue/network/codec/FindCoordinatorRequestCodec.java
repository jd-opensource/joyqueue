 ...
 * date: 2018/12/3
 */
public class FindCoordinatorRequestCodec implements PayloadCodec<JournalqHeader, FindCoordinatorRequest>, Type {

    @Override
    public FindCoordinatorRequest decode(JournalqHeader header, ByteBuf buffer) throws Exception {
