 ...
 * date: 2018/11/28
 */
public enum JournalqCommandType {
    ...
    private static final Map<Byte, JournalqCommandType> TYPES;

    static {
        Map<Byte, JournalqCommandType> types = Maps.newHashMap();
        for (JournalqCommandType commandType : JournalqCommandType.values()) {
    ...
    public static JournalqCommandType valueOf(byte code) {
