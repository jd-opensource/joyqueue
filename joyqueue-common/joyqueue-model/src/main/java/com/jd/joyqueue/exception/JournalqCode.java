...
//    SE_APPEND_MESSAGE_RATE_LIMIT(106, "写触发限流"),
    ...
    static {
        for (JournalqCode journalqCode : JournalqCode.values()) {
            codes.put(journalqCode.code, journalqCode);
        }
    }

    JournalqCode(int code, String message) {
        this.code = code;
     ...
     * @return
     */
    public static JournalqCode valueOf(int code) {
