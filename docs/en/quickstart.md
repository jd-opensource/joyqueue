...
- [Getting Started](#getting-started)
	...
	- [Step 2: Launch JoyQueue server with default config](#step-2-launch-joyqueue-server-with-default-config)
	- [Step 3: Launch JoyQueue console with default config](#step-3-launch-joyqueue-console-with-default-config)
	...
	- [Step 6: Produce and consume using Spring](#step-5-produce-and-consume-using-spring)
		...
		- [Step 6.2: Spring-JoyQueue.xml](#step-52-spring-joyqueuexml)
...
JoyQueue requires Maven 3.0 or higher.
...
## Step 2: Launch JoyQueue server with default config
...
[11:06:21:243] [main] [INFO] - com.jd.joyqueue.broker.joyqueueLauncher.main(JoyQueueLauncher.java:32) - >>>
>>>       _   __  __    ____  
>>>      | | |  \/  |  / __ \
>>>      | | | \  / | | |  | |
>>>  _   | | | |\/| | | |  | |
...
## Step 3: Launch JoyQueue console with default config
...
Making sure JoyQueue have started, **topic.sh** will assist you to config.
...
## Step 5: Produce and consume example
 ...
 In this section,You will try produce and consume message via JoyQueue. There are three ways to access JoyQueue,such as plain java,Spring or Spring boot style.
...
<beans xmlns="http://www.springframework.org/schema/beans"
    ...
    <oms:consumer queueName="test_topic" listener="com.jd.joyqueue.client.samples.spring.MessageListener1"></oms:consumer>
</beans>
```
...
The consumer which configured in Spring-joyqueue.xml should implement MessageListener as [Step 4.3: Consume example](#step 4.3 consume example).
Once the topic you have subscribe has new arriving messages,you consumer which configured in Spring-joyqueue.xml will be invoked.
