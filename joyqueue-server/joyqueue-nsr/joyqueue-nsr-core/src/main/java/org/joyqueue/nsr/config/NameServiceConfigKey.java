...
public enum NameServiceConfigKey implements PropertyDef {
    ...
    NAMESERVER_MESSENGER_PUBLISH_TOPIC_ENABLE("nameservice.messenger.publish.topic.enable", false, Type.BOOLEAN),
    NAMESERVER_MESSENGER_PUBLISH_SUBSCRIPTION_ENABLE("nameservice.messenger.publish.subscription.enable", false, Type.BOOLEAN),
    NAMESERVER_MESSENGER_PUBLISH_BROKER_ENABLE("nameservice.messenger.publish.broker.enable", false, Type.BOOLEAN),
