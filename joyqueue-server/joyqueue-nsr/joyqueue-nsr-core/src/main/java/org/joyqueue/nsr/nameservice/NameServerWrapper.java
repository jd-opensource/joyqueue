 ...
 * date: 2020/2/24
 */
public class NameServerWrapper extends Service implements NameService, PropertySupplierAware, Type {

    protected static final Logger logger = LoggerFactory.getLogger(NameServerWrapper.class);

    private NameServer delegate;
