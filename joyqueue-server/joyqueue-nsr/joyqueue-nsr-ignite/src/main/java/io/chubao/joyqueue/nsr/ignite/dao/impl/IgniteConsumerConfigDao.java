...
import static io.chubao.joyqueue.nsr.ignite.model.IgniteConsumerConfig.COLUMN_LIMIT_TPS;
import static io.chubao.joyqueue.nsr.ignite.model.IgniteConsumerConfig.COLUMN_LIMIT_TRAFFIC;
import static io.chubao.joyqueue.nsr.ignite.model.IgniteConsumerConfig.COLUMN_NAMESPACE;
import static io.chubao.joyqueue.nsr.ignite.model.IgniteConsumerConfig.COLUMN_TOPIC;
import static io.chubao.joyqueue.nsr.ignite.model.IgniteConsumerConfig.COLUMN_APP;
import static io.chubao.joyqueue.nsr.ignite.model.IgniteConsumerConfig.COLUMN_NEAR_BY;
import static io.chubao.joyqueue.nsr.ignite.model.IgniteConsumerConfig.COLUMN_ARCHIVE;
import static io.chubao.joyqueue.nsr.ignite.model.IgniteConsumerConfig.COLUMN_RETRY;
import static io.chubao.joyqueue.nsr.ignite.model.IgniteConsumerConfig.COLUMN_CONCURRENT;
import static io.chubao.joyqueue.nsr.ignite.model.IgniteConsumerConfig.COLUMN_ACK_TIMEOUT;
import static io.chubao.joyqueue.nsr.ignite.model.IgniteConsumerConfig.COLUMN_BATCH_SIZE;
import static io.chubao.joyqueue.nsr.ignite.model.IgniteConsumerConfig.COLUMN_BLACK_LIST;
import static io.chubao.joyqueue.nsr.ignite.model.IgniteConsumerConfig.COLUMN_DELAY;
import static io.chubao.joyqueue.nsr.ignite.model.IgniteConsumerConfig.COLUMN_MAX_RETRYS;
import static io.chubao.joyqueue.nsr.ignite.model.IgniteConsumerConfig.COLUMN_MAX_RETRY_DELAY;
import static io.chubao.joyqueue.nsr.ignite.model.IgniteConsumerConfig.COLUMN_RETRY_DELAY;
import static io.chubao.joyqueue.nsr.ignite.model.IgniteConsumerConfig.COLUMN_EXPIRE_TIME;
import static io.chubao.joyqueue.nsr.ignite.model.IgniteConsumerConfig.COLUMN_PAUSED;
import static io.chubao.joyqueue.nsr.ignite.model.IgniteConsumerConfig.COLUMN_ERROR_TIMES;
import static io.chubao.joyqueue.nsr.ignite.model.IgniteConsumerConfig.COLUMN_MAX_PARTITION_NUM;
import static io.chubao.joyqueue.nsr.ignite.model.IgniteConsumerConfig.COLUMN_RETRY_READ_PROBABILITY;
import static io.chubao.joyqueue.nsr.ignite.model.IgniteConsumerConfig.COLUMN_ID;
