 ...
 * date: 2018/9/10
 */
public class RetryMessageHandler implements JMQ2CommandHandler, Type, BrokerContextAware {
    ...
    public Command handle(Transport transport, Command command) throws TransportException {
        ...
        try {
            ...
            logger.error("putRetry exception, transport: {}, consumer: {}", transport, consumer, e);
