 ...
 */
package com.jd.joyqueue.broker.jmq2.security;
 ...
 * Date: 2019/1/21
 */
public class JMQ2Authentication implements Authentication {
    protected static final Logger logger = LoggerFactory.getLogger(JMQ2Authentication.class);
    ...
    public JMQ2Authentication(Authentication authentication,String adminUser, String adminPassword){
        this.adminUser = adminUser;
        this.adminPassword = adminPassword;
        this.jmq4Authentication = authentication;
    }
    public JMQ2Authentication(Authentication authentication,String adminUser, String adminPassword,String tokenPrefix){
