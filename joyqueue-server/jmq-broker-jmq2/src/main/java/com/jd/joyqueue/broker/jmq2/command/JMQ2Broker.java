 ...
 * </pre>
 */
public class JMQ2Broker implements Serializable, Comparable<JMQ2Broker> {
    ...
    public JMQ2Broker(String ip, int port) {
        this.ip = ip;
        this.port = port;
    }

    public JMQ2Broker(String ip, int port, String alias) {
        this.ip = ip;
        this.port = port;
        this.alias = alias;
    }

    public JMQ2Broker(String ip, int port, String alias, byte dataCenter) {
        this.ip = ip;
        this.port = port;
        this.alias = alias;
     ...
     * @return 复制数据
     */
    public JMQ2Broker clone() {
        JMQ2Broker target = new JMQ2Broker();
        target.setId(id);
        target.setIp(ip);
        target.setPort(port);
    ...
    public boolean equals(Object o) {
        ...
        JMQ2Broker broker = (JMQ2Broker) o;
     ...
     */
    @Override
    public int compareTo(JMQ2Broker o) {
        if (this == null && o == null) {
            return 0;
        }
        if (this != null && o == null) {
