 ...
 * date: 2018/8/28
 */
public class ConsumerHandler implements JMQ2CommandHandler, Types, BrokerContextAware {
    ...
    protected Command addConsumer(Transport transport, Command command, AddConsumer addConsumer) {
        ...
        consumer.setType(Consumer.ConsumeType.JMQ2);
    ...
    @Override
    public int[] types() {
        return new int[]{JMQ2CommandType.ADD_CONSUMER.getCode(), JMQ2CommandType.REMOVE_CONSUMER.getCode(), JMQ2CommandType.GET_CONSUMER_HEALTH.getCode()};
    }
}