 ...
 */
package com.jd.joyqueue.broker.kafka.network.protocol;

import com.jd.joyqueue.broker.BrokerContext;
import com.jd.joyqueue.broker.BrokerContextAware;
import com.jd.joyqueue.broker.kafka.KafkaConsts;
...
import com.jd.joyqueue.broker.kafka.coordinator.group.GroupBalanceHandler;
...
import com.jd.joyqueue.broker.kafka.coordinator.group.GroupMetadataManager;
import com.jd.joyqueue.broker.kafka.coordinator.group.GroupOffsetHandler;
import com.jd.joyqueue.broker.kafka.coordinator.group.GroupOffsetManager;
import com.jd.joyqueue.broker.kafka.coordinator.transaction.ProducerIdManager;
import com.jd.joyqueue.broker.kafka.coordinator.transaction.TransactionCoordinator;
import com.jd.joyqueue.broker.kafka.coordinator.transaction.TransactionHandler;
import com.jd.joyqueue.broker.kafka.coordinator.transaction.TransactionIdManager;
import com.jd.joyqueue.broker.kafka.coordinator.transaction.TransactionMetadataManager;
import com.jd.joyqueue.broker.kafka.coordinator.transaction.TransactionOffsetHandler;
import com.jd.joyqueue.broker.kafka.coordinator.transaction.ProducerSequenceManager;
import com.jd.joyqueue.broker.kafka.coordinator.transaction.completion.TransactionCompletionHandler;
import com.jd.joyqueue.broker.kafka.coordinator.transaction.completion.TransactionCompletionScheduler;
import com.jd.joyqueue.broker.kafka.coordinator.transaction.log.TransactionLog;
import com.jd.joyqueue.broker.kafka.coordinator.transaction.synchronizer.TransactionSynchronizer;
import com.jd.joyqueue.broker.kafka.manage.KafkaManageServiceFactory;
import com.jd.joyqueue.broker.kafka.network.helper.KafkaProtocolHelper;
import com.jd.joyqueue.broker.kafka.session.KafkaConnectionHandler;
import com.jd.joyqueue.broker.kafka.session.KafkaConnectionManager;
import com.jd.joyqueue.broker.kafka.session.KafkaTransportHandler;
...
public class KafkaProtocol extends Service implements ProtocolService, BrokerContextAware, CommandHandlerProvider, ExceptionHandlerProvider {
    ...
    public void setBrokerContext(BrokerContext brokerContext) {
        com.jd.joyqueue.broker.coordinator.group.GroupMetadataManager groupMetadataManager =
                brokerContext.getCoordinatorService().getOrCreateGroupMetadataManager(KafkaConsts.COORDINATOR_NAMESPACE);
        com.jd.joyqueue.broker.coordinator.transaction.TransactionMetadataManager transactionMetadataManager =
