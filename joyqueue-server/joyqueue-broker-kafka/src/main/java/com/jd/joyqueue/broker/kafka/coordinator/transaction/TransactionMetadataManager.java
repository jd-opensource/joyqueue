 ...
 */
package com.jd.joyqueue.broker.kafka.coordinator.transaction;
...
public class TransactionMetadataManager {
    ...
    private com.jd.joyqueue.broker.coordinator.transaction.TransactionMetadataManager transactionMetadataManager;

    public TransactionMetadataManager(KafkaConfig config, com.jd.joyqueue.broker.coordinator.transaction.TransactionMetadataManager transactionMetadataManager) {
        this.config = config;
