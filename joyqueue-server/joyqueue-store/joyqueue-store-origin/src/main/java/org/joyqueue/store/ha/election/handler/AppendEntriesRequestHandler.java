...
import org.joyqueue.store.ha.election.LeaderElection;
import org.joyqueue.store.ha.election.command.AppendEntriesRequest;
import org.joyqueue.store.ha.election.command.AppendEntriesResponse;
...
//        }
        this.electionManager =null;//(ElectionManager)brokerContext.getElectionService();
    }
