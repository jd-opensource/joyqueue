...
public class StoreServiceTest {
    ...
    public void performanceTest() throws Exception {
        ...
        for (int i = 0; i < count; i++) {
            ...
            Future<WriteResult> future = partitionGroupStore.asyncWrite(QosLevel.REPLICATION,Arrays.stream(messages).map(b -> new WriteRequest(partition, b)).toArray(WriteRequest[]::new));
