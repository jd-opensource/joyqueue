...
public enum ClusterConfigKey implements PropertyDef {
    ...
    GET_TOPIC_DYNAMIC_METADATA_BATCH_MIN_THREADS("cluster.topic.dynamic.metadata.batch.min.threads", 8, Type.INT),
    GET_TOPIC_DYNAMIC_METADATA_BATCH_MAX_THREADS("cluster.topic.dynamic.metadata.batch.max.threads", Runtime.getRuntime().availableProcessors(), Type.INT),
