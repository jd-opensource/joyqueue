...
public enum ConsumeConfigKey implements PropertyDef {
    ...
    BROADCAST_INDEX_RESET_INTERVAL("consume.broadcast.index.reset.interval", 1000 * 30, Type.INT),
    BROADCAST_INDEX_RESET_TIME("consume.broadcast.index.reset.time", 1000 * 60 * 60 * 24 * 2, Type.INT),
    REPLICATE_CONSUME_POS_INTERVAL("consume.replicate.interval", 1000 * 30, Type.INT),
    ;
    private String name;
