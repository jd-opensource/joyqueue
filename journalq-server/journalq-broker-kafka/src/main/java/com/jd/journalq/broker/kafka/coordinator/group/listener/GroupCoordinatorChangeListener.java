...
//        if (!groupCoordinatorResolver.isCoordinatorTopic(new TopicName(event.getTopicPartitionGroup().getGroupTopic()))) {
//            return;
//        }
//
//        Broker currentBroker = clusterManager.getBroker();
//        List<GroupMetadata> invalidGroups = Lists.newLinkedList();
//        List<GroupMetadata> groups = groupMetadataManager.getTransactions();
...
//            groupMetadataManager.removeTransaction(group);
//        }
//    }
//}