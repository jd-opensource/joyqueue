 ...
 * date: 2019/4/4
 */
public class AddPartitionsToTxnHandler implements KafkaCommandHandler, Type, KafkaContextAware {

    protected static final Logger logger = LoggerFactory.getLogger(AddPartitionsToTxnHandler.class);
    ...
    public Command handle(Transport transport, Command command) {
        ...
        try {
            logger.info("add partition to txn, request: {}", addPartitionsToTxnRequest);
