 ...
 * date: 2019/4/4
 */
public class InitProducerIdHandler implements KafkaCommandHandler, Type, KafkaContextAware {

    protected static final Logger logger = LoggerFactory.getLogger(InitProducerIdHandler.class);
