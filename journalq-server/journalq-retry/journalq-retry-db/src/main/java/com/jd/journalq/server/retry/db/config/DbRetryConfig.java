...
/**
 * Created by chengzhiliang on 2019/1/24.
 */
public class DbRetryConfig {

    enum Enum {
        WRITE_URL("retry.mysql.url.write", ""),
        WRITE_USER_NAME("retry.mysql.username.write", ""),
        WRITE_PASSWORD("retry.mysql.password.write", ""),
        DRIVER("retry.mysql.driver", ""),
    ...
    private static final Logger logger = LoggerFactory.getLogger(DbRetryConfig.class);
