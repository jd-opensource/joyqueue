 ...
 * date: 2018/8/27
 */
public class JournalqLauncher {
    protected static final Logger logger = LoggerFactory.getLogger(JournalqLauncher.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            InputStream inputStream = JournalqLauncher.class.getClassLoader().getResourceAsStream(SYSTEM_EVN_FILE);
            if (null != inputStream) {
