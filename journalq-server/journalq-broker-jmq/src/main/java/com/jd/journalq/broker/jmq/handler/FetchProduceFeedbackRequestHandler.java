 ...
 * date: 2018/12/19
 */
public class FetchProduceFeedbackRequestHandler implements JMQCommandHandler, Type, BrokerContextAware {
    ...
    @Override
    public int type() {
        return JMQCommandType.FETCH_PRODUCE_FEEDBACK_REQUEST.getCode();
    }
}