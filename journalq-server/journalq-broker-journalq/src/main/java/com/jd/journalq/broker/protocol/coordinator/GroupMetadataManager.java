 ...
 */
package com.jd.journalq.broker.protocol.coordinator;
...
public class GroupMetadataManager {
    ...
    public GroupMetadataManager(JournalqConfig config, com.jd.journalq.broker.coordinator.group.GroupMetadataManager groupMetadataManager) {
        this.config = config;
