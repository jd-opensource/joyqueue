 ...
 */
package com.jd.journalq.broker.coordinator.assignment;
...
import com.jd.journalq.broker.coordinator.assignment.delay.MemberTimeoutDelayedOperation;
...
public class PartitionAssignmentHandler extends Service {
    ...
    public PartitionAssignmentHandler(JournalqConfig config, JMQCoordinatorGroupManager coordinatorGroupManager) {
        this.config = config;
    ...
    protected void validate() throws Exception {
        ...
        memberTimeoutDelayedOperationManager = new DelayedOperationManager("journalqMemberTimeout");
    }
