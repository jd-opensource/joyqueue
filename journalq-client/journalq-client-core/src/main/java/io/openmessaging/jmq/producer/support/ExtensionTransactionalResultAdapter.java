...
public class ExtensionTransactionalResultAdapter implements ExtensionTransactionalResult {
    ...
    public SendResult send(Message message) {
        try {
            ...
            com.jd.journalq.client.internal.producer.domain.SendResult sendResult = transactionMessageProducer.send(messageAdapter.getProduceMessage());
    ...
    public List<SendResult> send(List<Message> messages) {
        try {
            ...
            List<com.jd.journalq.client.internal.producer.domain.SendResult> sendResults = transactionMessageProducer.batchSend(produceMessages);
